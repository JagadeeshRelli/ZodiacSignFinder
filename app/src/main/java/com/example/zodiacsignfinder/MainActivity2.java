package com.example.zodiacsignfinder;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intValues == 4) { points2.setText("Your zodiac sign is:");
            points2.setText("Your zodiac sign is:");
        ...
        if (intValues == 5) { points2.setText("Your zodiac sign is:");
        ...
        if (intValues == 6) { points2.setText("Your zodiac sign is:");
        ...
        if (intValues == 7) { points2.setText("Your zodiac sign is:");
        ...
        if (intValues == 8) { points2.setText("Your zodiac sign is:");
            txt.setText(
        ...
        if (intValues == 9) { points2.setText("Your zodiac sign is:");
        ...
        if (intValues == 10) { points2.setText("Your zodiac sign is:");
        ...
        if (intValues == 11) { points2.setText("Your zodiac sign is:");
        ...
        if (intValues == 12) { points2.setText("Your zodiac sign is:");
